...
const RequestAid = () => {
  ...
  const handleSubmitForAid = (e: React.MouseEvent<any>) => {
    ...
    const description = (document.querySelector('#requestAid_description') as HTMLInputElement)
      .value
    let latLng = {
      lat: 0,
      lng: 0,
    ...
    if (attachAddress) {
      ...
      console.log('fire2')
      axios
        .post(URL_FOR_AID, { email: userData.email, address: '', description: description })
        .then(res => {
          console.log(res)
        })
    }
        ...
        <form>
          <div className="flex flex-col justify-center items-center mt-6">
            ...
            <div className="flex flex-col w-11/12 mt-10">
              <span>
                <label className="form-label mr-4">Attach Location ?</label>
                <input id="attachLocationCheckbox" type="checkbox"></input>
              </span>
              <input
                id="addressForAid"
                type="text"
            ...
            <button
              onClick={e => handleSubmitForAid(e)}
