    ...
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-screen m-3 flex justify-center max-w-md">
          <input
            id="login_email"
            className="input input-bordered bg-slate-100 w-10/12"
            placeholder="Email"
          ></input>
        </div>
        <div className="w-screen m-3 flex justify-center max-w-md">
        ...
        <div className="flex justify-around">
          ...
          <input
            ref={checkboxRef}
            type="checkbox"
            className="checkbox ml-3 checkbox-accent"
          ></input>
        </div>
        <div className="w-screen m-3 flex justify-center max-w-md">
          <button
            onClick={handleLogin}
            className="btn w-10/12 bg-gradient-to-r from-accent to-neutral"
          >
            Sign In
          </button>
        </div>
        <p className="pt-5 text-center">
          ...
          <br />
          <Link href="/register">
            <a className="link link-primary">Register instead</a>
          </Link>
        </p>
      </div>
    </div>
