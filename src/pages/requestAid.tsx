    ...
    return (
        <div className="w-screen h-screen">
            ...
            <div className="rounded-[50px] flex flex-row justify-start items-center z-10 absolute top-0 w-full bg-gray-800 p-3 border-4 border-gray-500">
                <button
                    className="w-10 h-3 flex items-center ml-3"
                    onClick={clickBack}
                >
            ...
            {showModal ? (
                <div className="pls z-20 w-screen h-screen bg-gray-700/80 absolute top-0 flex justify-center">
